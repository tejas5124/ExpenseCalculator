...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void Submit(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Submit
        ...
        if (email.isEmpty() || password.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "E-mail and Password are required!");
            return;
        }
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query)) {
                ...
                try (ResultSet rs = pstmt.executeQuery()) {
                    if (rs.next()) {
                        javax.swing.JOptionPane.showMessageDialog(this, "Login successful! Welcome, " + rs.getString("name"));
    ...
    private void Go_to_login(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Go_to_login
        // TODO add your handling code here:
        LoginPage l = new LoginPage();
        l.setVisible(true);
        this.dispose(); // Close the current window
    }//GEN-LAST:event_Go_to_login
